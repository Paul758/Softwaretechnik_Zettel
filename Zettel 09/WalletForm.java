...
//						,"png", "gif", "jpg", "jpeg", "doc", "docx", "txt", "pdf", "csv", "xls");
		...
		//Für Übung 09 hinzugefügt
		buttonSearch.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				ListSearchForm lsf = new ListSearchForm();
				lsf.setSize(640, 360);
				lsf.setLocationRelativeTo(frame);
				lsf.setVisible(true);
				EventDispatcher.instance.dispatchEvent(new MHIEvent(EventType.UserCheckInEvent, "buttonSearch", null));
			}
		});
